...
> `lurkinghorror.txt`) is now fully labeled — **54 Done** (mostly already-built; the
> "we don't have" framing was stale), **18 Won't do**, **16 Will do**. Shipped 2026-07-11:
...
> Remaining Will-do work
> clusters into: enter/exit + vehicles (incl. non-vehicle enterables); `take X from Y`
> scope-narrowing; NPC talk/greet/order + `ask for`/`feed` (own design doc); verbose/brief/superbrief
