...
lamplighter.createObject("game", "My Little Game", {  });
const hall = lamplighter.createObject("room", "hall", { "description": "A hall." });
...
lamplighter.getObject("My Little Game").start = lamplighter.getObject("hall");
