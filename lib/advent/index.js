...
// `closed` is advent's field; core stays generic via the barrier seam.
lamplighter.registerScopeBarrier((container) => !!container.closed);
...
// name, a string quoted, primitives verbatim. (A `text` thunk has no name; show a marker.)
